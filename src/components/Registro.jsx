    ...
    return (
        ...
        <div className="layout__registro">
            ...
            <div className="registro__icons">
                <SocialButton icon='fa-brands fa-facebook fa-3x icon '></SocialButton>
                <SocialButton icon='fa-brands fa-github fa-3x icon '></SocialButton>
                <SocialButton icon='fa-brands fa-linkedin fa-3x icon '></SocialButton>
            </div>
